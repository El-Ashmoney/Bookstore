...
<section class="mb-n9 mb-lg-n11 p-0" style="transform: translateY(calc(-50% - 25px));">
    <div class="container-fluid">
        <div class="position-relative hero-carousel-container" id="heroCarouselContainer">
            <div class="position-absolute translate-middle d-none d-xxl-block">
                <img src="web/assets/img/illustrations/bg-circle.png" alt="" />
            </div>
            ...
            <div class="carousel slide" id="hero-carousel" data-bs-ride="carousel">
                <div class="slider-rectangle z-index-2 d-none d-xxl-block">
                    <img src="web/assets/img/gallery/rectangle-s.png" alt="" />
                </div>
                <div class="position-relative">
                    ...
                    <div class="carousel-inner" id="heroCarouselInner">
                        <div class="carousel-item active"><img class="d-block w-100" src="web/assets/img/gallery/header-slider-1.png" height="447" alt="..." />
                        ...
                        <div class="carousel-item"><img class="d-block w-100" src="web/assets/img/gallery/header-slider-2.png" height="447" alt="..." />
                            <div class="carousel-caption d-none d-sm-block">
